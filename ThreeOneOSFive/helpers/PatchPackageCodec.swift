...
enum PatchPackageCodec {
    ...
    // Version 3 is used by the bundled FF 2022 packages. The envelope,
    // authenticated payload, and Codable project shape remain compatible;
    // accepting it here lets the same patch transaction path handle both
    // built-in and imported packages.
