<p align="center">
  <img src="docs/images/app-icon.png" width="132" alt="External app icon">
</p>

<h1 align="center">External</h1>

<p align="center">
  A native iOS workspace for portable patches and app-container file operations.
</p>

<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-0.0.2-0000FF?style=flat-square">
...
- **Responsive navigation** — iPad split-view and landscape support, stable search fields, and refined icon/row sizing.

See the complete [Patch workspace guide](docs/PATCH_GUIDE.md).

## Highlights

- **Patch file operations** — search, preview, share, import multiple files, copy, move, paste, rename, delete, create files and folders, make ZIP archives, and safely handle name conflicts.
...
- The Theos IPA build uses the valid bundle identifier `com.dts.external.ios.app`; the container bridge accepts this identifier and the legacy `com.apple.mobile.MobileHouseArrest` identifier.
...
├── Makefile                 # Theos/IPA-bot application definition
├── application.mk           # arm64/rootless bot configuration
